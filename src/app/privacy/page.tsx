        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-16 pb-12 md:pt-24 md:pb-16">
          <div className="text-center">
            ...
            <p className="mx-auto mt-4 max-w-3xl text-base sm:text-lg md:text-xl text-neutral-300">
              At Neonovallc, your privacy is our priority. This policy outlines
      ...
      <section className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pb-14 md:pb-20">
        <div className="space-y-10">
          ...
          <ul className="list-disc pl-6 space-y-3">
            <li>
              Personal details such as your name, company name, job title, email
              address, phone number, and mailing address when provided through
              forms or inquiries.
            </li>
            <li>
              Technical information, including IP address, browser type, device
              type, and browsing behavior on our Site.
            </li>
            <li>
              Data collected through cookies and tracking technologies to
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>
              Send newsletters, updates, and promotional materials (only if you
              have opted in).
            </li>
          ...
          <p className="text-neutral-300">
            If you receive marketing emails from us, you may opt out at any time
            by:
          </p>
          <ul className="list-disc pl-6 space-y-3">
            <li>
          ...
          <p className="text-neutral-300">
            ...
            communications, though we may still contact you regarding essential
            service or account-related matters.
          </p>
          ...
          <p className="text-neutral-300">
            ...
            parties. However, information may be shared only in these cases:
          </p>
          <ul className="list-disc pl-6 space-y-3">
            <li>
              With trusted third-party service providers (such as payment
              processors or analytics tools) bound by confidentiality and data
          ...
          <p className="text-neutral-300">
            ...
            to safeguard your data. While we strive to protect your information,
          ...
          <p className="text-neutral-300">
            Our Site uses cookies and similar technologies to enhance
            functionality, analyze traffic, and improve your browsing
            experience. You may disable cookies in your browser settings, though
            some features may not work as intended.
          </p>

          <h2 className="text-2xl sm:text-3xl md:text-4xl font-bold tracking-tight">
            9. Testimonials, Endorsements & Claims Disclaimer
          </h2>
          <p className="text-neutral-300">
            Testimonials, endorsements, or success stories on our Site represent
            individual experiences and results, which may vary. They are not
            guarantees of similar outcomes. Where applicable, claims are based
            on verifiable information. We disclaim responsibility for unverified
          ...
          <p className="text-neutral-300">
            ...
            responsible for the content, practices, or policies of those sites.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-3">
            ...
            <li>
              Phone:{" "}
              <a href="tel:+12137841841" className="text-[var(--accent)]">
                +1 (213) 784-1841
              </a>
            </li>
